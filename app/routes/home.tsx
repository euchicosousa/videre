...
export const VIDERE = () => {
  return (
    ...
    >
      <path
        d="M-1600.744-2162.998q.244 5.219.244 10.498c0 122.801-99.699 222.5-222.5 222.5s-222.5-99.699-222.5-222.5 99.699-222.5 222.5-222.5q5.279 0 10.498.244c-106.848 5.22-191.998 93.623-191.998 201.756 0 111.487 90.513 202 202 202 108.133 0 196.536-85.15 201.756-191.998"
        transform="translate(4482.61 5204.693)scale(2.19145)"
      />
      <path
        d="M-1766.078-1990.775A190 190 0 0 1-1798.5-1988c-104.312 0-189-84.688-189-189s84.688-189 189-189 189 84.688 189 189c0 12.316-1.181 24.359-3.435 36.021.523-5.374.79-10.822.79-16.332 0-92.194-74.85-167.044-167.044-167.044s-167.044 74.85-167.044 167.044 74.85 167.044 167.044 167.044a169 169 0 0 0 13.111-.508"
        fill="#5d99b7"
        transform="translate(4482.61 5204.693)scale(2.19145)"
      />
      <path
        d="M-1876.871-2276.067c25.808-20.34 58.372-32.481 93.75-32.481 83.692 0 151.638 67.947 151.638 151.638s-67.946 151.639-151.638 151.639c-33.818 0-65.065-11.095-90.297-29.839 19.325 10.348 41.402 16.218 64.839 16.218 75.973 0 137.653-61.68 137.653-137.653s-61.68-137.654-137.653-137.654c-24.845 0-48.161 6.597-68.292 18.132"
        transform="translate(4482.61 5204.693)scale(2.19145)"
      />
      <path
        d="M4566.958 999.013h3.621l-16.3 37.25h-5.341l-16.3-37.25h4.363c1.523 0 2.902.902 3.511 2.297l12.696 29.053z"
        fillRule="nonzero"
        transform="translate(-69117.848 -15250.68)scale(15.49888)"
      />
      <path
        d="M4571.288 999.013h3.199a3.52 3.52 0 0 1 3.521 3.522v33.728h-6.72z"
        fillRule="nonzero"
        transform="matrix(15.49888 0 0 -15.49888 -69052.105 16293.829)"
      />
      <path
        d="M4581.738 1002.531v-3.568h13.47c15.019 0 20.971 8.215 20.971 18.7 0 9.67-3.648 18.6-21.071 18.6l-6.75-.05h-6.72v-1.45l.095-30.832h3.198a3.51 3.51 0 0 1 3.512 3.523l-.085 25.188h4.8c8.273 0 16.3-3.679 16.3-14.979 0-9.179-6.371-15.079-16.2-15.079z"
        fillRule="nonzero"
        transform="translate(-68986.361 -15250.68)scale(15.49888)"
      />
      <path
        d="M16244.554 285.902V181.125h133.32v19.336h-96.927v66.105h119.128v19.336zm36.393-112.627c-6.606 0-24.426-2.624-29.097-7.295a24.9 24.9 0 0 1-7.296-17.613V84.198h155.521v19.336h-119.128z"
        transform="translate(-43814.37 -8.09)scale(2.86228)"
      />
      <path
        d="M16244.554 285.902V181.125h133.32v19.336h-96.927v66.105h119.128v19.336zm36.393-112.627c-6.606 0-24.426-2.624-29.097-7.295a24.9 24.9 0 0 1-7.296-17.613V84.198h155.521v19.336h-119.128z"
        transform="translate(-42703.226 -8.09)scale(2.86228)"
      />
      <path
        d="M4649.738 1018.366v-19.353h20.041c9.785 0 10.55 8.317 10.55 9.65 0 1.2-.404 9.551-8.55 9.55l12.25 18.05h-7.671l-12.2-17.9zm3.199 1.45a3.52 3.52 0 0 1 3.521 3.522v12.925h-6.72v-16.447zm13.721-5.074c5.992 0 6.95-3.815 6.95-6.079 0-1.84-.534-6.079-6.95-6.079h-10.2v12.158z"
        transform="translate(-68854.874 -15250.68)scale(15.49888)"
      />
    </svg>
    // <svg
    //   clipRule="evenodd"
